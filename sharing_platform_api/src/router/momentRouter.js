...
// 根据用户id获取对应用户列表
momentRouter.get("/userId/:userId", MomentController.getMomentByUserId);
...
momentRouter.get("/labelId/:id", MomentController.getMomentByLabel);
// 增加一个访问量
momentRouter.get("/views/:id", MomentController.increaseViews);
// 获取动态根据访问量排序
momentRouter.get("/getByViews/three",MomentController.getMomentByViews);
